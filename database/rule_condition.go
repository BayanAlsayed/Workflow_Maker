...
func AddRuleCondition(WF_CONDITION_ID int, CONDITION_TYPE string, RULE_ID int, WORKFLOW_ID int, VERSION int) error {
	...
	ruleConditionID, err := getNextRuleConditionID(WF_VERSION_ID, RULE_ID)
	if err != nil {
		return err
	}
